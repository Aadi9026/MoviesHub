...
const VideoPage = () => {
  ...
  // UPDATED: Generate breadcrumb structured data with proper URLs
  const getBreadcrumbSchema = () => ({
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `https://ytmovieshub.website/category/${video?.genre || 'movies'}`
      },
      {
        "@type": "ListItem",
        "position": 3,
  ...
  return (
    <div className="video-page">
      ...
      {/* UPDATED: Breadcrumb Structured Data with proper URLs */}
