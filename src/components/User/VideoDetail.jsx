...
const VideoDetail = () => {
  ...
  // Update global video context when video changes
  useEffect(() => {
    if (video) {
      playVideo({
        ...
        <div className="container">
          <div className="error-container">
            <div className="error-message">
              ...
              <p>
                This video doesn't have any valid embed codes. Please
  ...
  const availableDownloads = video.downloadLinks
    ? Object.entries(video.downloadLinks).filter(
        ([_, link]) => link && link.trim() !== ''
      )
    : [];
  ...
  return (
    <div className="video-detail-page">
      ...
      <div className="video-player-fullwidth">
        <VideoPlayer embedCode={sources[currentSource]?.code} title={video.title} />
      </div>
            ...
            <div className="video-info">
              ...
              <div className="horizontal-action-bar">
                ...
                >
                  {/* Like Button */}
                  <button
                    className={`action-bar-btn like-btn ${
                      liked ? 'active' : ''
                    }`}
                    onClick={handleLike}
                  ...
                  >
                    ...
                    <span>Like</span>
                    {likeCount > 0 && (
                      <span className="btn-counter">{likeCount}</span>
                    )}
                  </button>

                  {/* Dislike Button */}
                  <button
                    className={`action-bar-btn dislike-btn ${
                      disliked ? 'active' : ''
                    }`}
                  ...
                  >
                    ...
                    <span>Dislike</span>
                    {dislikeCount > 0 && (
                      <span className="btn-counter">{dislikeCount}</span>
                    )}
                  </button>
