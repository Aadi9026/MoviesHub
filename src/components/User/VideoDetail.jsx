...
const VideoDetail = () => {
  ...
  // Scroll detection for dimming effect
  useEffect(() => {
    const handleScroll = () => {
  ...
  useEffect(() => {
    ...
    setIsScrolled(false); // Reset scroll state on video change
  }, [id, video]);

  // ... keep all your existing functions (handleLike, handleDislike, handleShare, etc.)
  ...
  // Prepare video sources (keep your existing logic)
  const sources = [];
