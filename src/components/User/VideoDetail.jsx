...
const VideoDetail = () => {
  ...
  const handleShare = async () => {
    try {
      // Create the share URL - use your actual website domain
      const shareUrl = `https://ytmovieshub.website/video/${id}`;
      
      if (navigator.share) {
        // Web Share API for mobile devices
        await navigator.share({
          title: video.title,
          text: video.description || `Watch ${video.title} on YTMoviesHub`,
          url: shareUrl,
        });
              ...
              <div className="video-info">
                ...
                <div className="horizontal-action-bar">
                  ...
                  >
                    ...
                    {/* FIXED Share Button with Tooltip */}
                    <div className="share-button-container">
                      ...
                      {showShareTooltip && (
                        <div className="share-tooltip">
                          ...
                          Link copied! Share: https://ytmovieshub.website/video/{id}
                        </div>
                      )}
                    </div>
